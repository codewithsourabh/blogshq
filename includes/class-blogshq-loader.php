...
class BlogsHQ_Loader {
	...
	/**
	 * A utility function used to register actions and hooks into a single collection.
	 *
	 * @since  1.0.0
	 * @access private
	 ...
	 * @return array                 The collection of hooks that are registered.
	 */
