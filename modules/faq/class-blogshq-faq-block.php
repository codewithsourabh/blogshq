...
class BlogsHQ_FAQ_Block {
	...
	public function register_block() {
		...
		wp_register_style(
			'blogshq-faq-block-style',
			BLOGSHQ_PLUGIN_URL . 'modules/faq/css/faq-block.css',
			array(),
			BLOGSHQ_VERSION
		);
		...
		register_block_type(
			'blogshq/faq-block',
			array(
				'editor_script'   => 'blogshq-faq-block',
				'editor_style'    => 'blogshq-faq-block-editor',
				'style'           => 'blogshq-faq-block-style',
	...
	public function enqueue_editor_assets() {
		// Editor styles are already registered and will be loaded by WordPress
	}
